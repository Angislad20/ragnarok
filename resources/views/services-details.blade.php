...
@section('content')
    ...
    <section class="pt10 pb90 pb30-md">
      <div class="container">
              ...
              <div class="blog-sidebar ms-lg-auto">
                ...
                <div class="freelancer-style1 service-single mb-0">
                  ...
                  <div class="d-grid mt30">
                    <a href="#" class="ud-btn btn-thm-border">Faire un devis<i class="fal fa-arrow-right-long"></i></a>
                  </div>
                </div>
              </div>   
          </div>
        ...
        <div class="modal_popup">
                  <h2>Entrez les details</h2>
                  <p>Definissez vous memes ce que vous rechercher <br> pour une meillleure prise en charge</p>
                  <h3>Categories</h3>
                  <select name="category" id="slct1">
                     <option selected disabled>Choisir une catégoririe</option>
                   </select>
                  <h3>Services</h3>
                  <select name="cat_services" id="slct2">
                     <option selected disabled>Choisir un service</option>
                  </select><br>
                  <label for="dserv">Details du Client</label><br>
                  <textarea class="details_services" id="dserv"></textarea>
                  <button type="submit" class="ud-btn super">Envoyer</button>
          </div>
      </div>
    </div>
  </section>
    ...
    <script>
      let category = ["Formation pro et diplomatique", "Finance, Juridique et conseil", "Production/Boulangerie", "Technologie/Energie"];
      let category_1 = ["Cryptomonnaie", "Bourse Trading", "Metier du secteur informel", "Politique/Diplomatique", "Administrative"];
      let category_2 = ["Installation et gestion de bases de données comptable de pilotage de gestion", "Elaboration et certification et compte et resultat de bilan et financier", "Ellaboration et stratégie de bonne gouvernance et dévellopement des affaires", "Redaction Gestion et Suivi de projet", "Assistance aux contentieux fiscal, Declaration et Enregistrement"];
      let category_3 = ["Vente de Materiel de Boulangerie", "Location de Boulangerie", "Vente de boulangerie", "Espace travailleurs", "Assistance"];
      let category_4 = ["Installation de Système Informatique De Gestion d'Entreprise", "Innovations Technologiques", "Energie Renouvelable/Energies Verte", "Produits Technologiques et Energétiques", "Cyber Defense, Securité Informatique"];
      ...
      slct1.onchange =function () {
        ...
        switch (this.value) {
          case "Formation pro et diplomatique":
          addToSlct2(category_1);
          break;
          case "Finance, Juridique et conseil":
          addToSlct2(category_2);
          break;
          case "Production/Boulangerie":
          addToSlct2(category_3);
          break;
          case "Technologie/Energie":
          addToSlct2(category_4);
          break;
        }
      }
    ...
    <script>
      const btn = document.querySelector('.btn-thm-border');
